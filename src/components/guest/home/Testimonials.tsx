...
const testimonialContainer = createStaggerContainer(0.15, 0.1);
        ...
        >
          {testimonials.map((item, index) => (
            <motion.div
              ...
              className="relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-7 md:p-8 shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-gray-100"
            >
              {/* Quote Icon */}
              <motion.div
                ...
                viewport={{ once: true }}
                className="absolute right-6 sm:right-8 top-6 sm:top-8 text-sky-500/10"
              >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex gap-1 text-sky-400 mb-4 sm:mb-6"
              >
                {[1, 2, 3, 4, 5].map((star) => (
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="text-sm sm:text-base text-gray-600 leading-6 sm:leading-7"
              >
